<template>
  <div class="dictionaries">
    <div class="window_load">
      ...
      <textarea
        style="width:460px;height:85px;box-sizing:border-box;resize:none;"
        @blur="getValue($event)"
      ></textarea>
      <div style="display:flex;flex-direction:row-reverse;padding-top:10px;">
        <button
          @click="aboutNone"
          style="width:100px;height:33px;margin-right:8px;"
        >取消</button>
        <button
          @click="sure"
          style="width:100px;height:33px;margin-right:8px;"
  ...
  methods: {
    ...
    sure() {
      if (this.cancleReason == "") {
        ...
        this.api.cancleOperationMaster(dataType).then(res => {
