<template>
    <div style="position: relative;">
        <div v-if="page == false" style="width:800px;display:flex;flex-wrap: wrap;">
            <div v-for="data in anesDate" style="width:195px;height:20px;font-size:12px;">
                            ...
                            if (num.indexOf("KG") == -1) {
                                ...
                                if (num.indexOf("MIN") == -1) {
                                    ...
                                    if (aff.list[a].ENDDATE) {
                                        ...
                                        // console.log(min)
                                        var timeOF = aff.list[a].PERFORM_SPEED * aff.list[a].PERFORM_SPEED * min
                                        this.$set(aff.list[a], 'DOSAGE', timeOF)
                                    } else {
                                         sTime = new Date(aff.list[a].START_TIME).getTime()
                                ...
                                if (num.indexOf("MIN") == -1) {
                                    ...
                                    if (aff.list[a].ENDDATE) {
                                        ...
                                        // return Math.round(min)
                                        // console.log(min)
                                        var timeOF = aff.list[a].PERFORM_SPEED * aff.list[a].PERFORM_SPEED * min * this.weight
                                        this.$set(aff.list[a], 'DOSAGE', timeOF)
                                    } else {
                                         sTime = new Date(aff.list[a].START_TIME).getTime()
                                         enTime = new Date(this.config.patientMaxTime).getTime()
