    ...
    <div v-if="!page">
      ...
      <div>
        <div
          ...
          style="width: 160px;border-bottom: 1px solid #8391a2;  font-size: 14px;position: absolute;left: -165px;padding-left: 5px;white-space:nowrap;word-break: keep-all;"
        >
      ...
      >
        ...
        >
          ...
          <span
            v-else
            style="padding: 0 2px 0 0px;background-color: white;"
          >
  ...
  methods: {
    ...
    xTimeInit() {
      ...
      if (
        ...
        this.config.userInfo.inDateTime != "" &&
        this.config.userInfo.inDateTime != null &&
        !this.page
      ) {
