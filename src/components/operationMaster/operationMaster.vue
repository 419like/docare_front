<template>
  <div v-if="!settingView"
       ...
       @click="allNone()">
    <!-- <div style="width: 100%;height: 100%;background-color: #ebf1f9;position: absolute;top: 0;left:0;z-index: 999;"
         v-if="printLoading">
      <div class="loading">
    ...
    <div class="head">
      ...
      <div class="procedure"
        ...
        <div style="display: flex;height:70px;"
          ...
          <div style="margin:0px 10px;">
            <div class="lightBox"
              ...
              <img v-if="lockedPatientInfo.operStatus == 0"
                   style="display:block"
                   src="../../assets/grayLight.png"
                   alt="">
              <img v-else-if="lockedPatientInfo.operStatus == 5"
                   style="display:block"
              ...
              <div v-if="doShowDataOne"
                   class="inseide">
                <div class="insideHover"
                     @click="finalStatus('0')">取消状态【入手术室】</div>
              </div>
            </div>
            <div style="position: relative;">
              ...
              <dateTime width="110"
                        v-model="inDateTime"
                        @change="changeStatus('5','inDateTime',$event)"></dateTime>
          ...
          <div style="margin:0px 10px;"
            ...
            <div class="lightBox"
              ...
              <img v-if="lockedPatientInfo.operStatus == 10"
                   style="display:block"
                   src="../../assets/redLight.png"
                   alt="">
              <img v-else-if="lockedPatientInfo.operStatus == 5"
              ...
              <div v-if="doShowDataTwo"
                   class="inseide">
                <div class="insideHover"
                     @click="finalStatus('5')">转入状态【入手术室】</div>
              </div>
            </div>
            <div>
              <dateTime width="110"
                        v-model="anesStartTime"
                        @change="changeStatus('10','anesStartTime',$event)"></dateTime>
          ...
          <div style="margin:0px 10px;"
            ...
            <div class="lightBox"
              ...
              <img v-if="lockedPatientInfo.operStatus == 10"
                   ...
                   src="../../assets/grayLight.png"
                   alt="">
              <img v-else-if="lockedPatientInfo.operStatus == 15"
                   style="display:block"
                   src="../../assets/redLight.png"
                   alt="">
              <img v-else
              ...
              <div v-if="doShowDataThree"
                   class="inseide">
                <div class="insideHover"
                     @click="finalStatus('10')">转入状态【麻醉开始】</div>
              </div>
            </div>
            <div>
              <dateTime width="110"
                        v-model="startDateTime"
                        @change="changeStatus('15','startDateTime',$event)"></dateTime>
          ...
          <div style="margin:0px 10px;"
            ...
            <div class="lightBox"
              ...
              <img v-if="lockedPatientInfo.operStatus == 15"
                   style="display:block"
                   src="../../assets/grayLight.png"
                   alt="">
              <img v-else-if="lockedPatientInfo.operStatus == 25"
                   style="display:block"
                   src="../../assets/redLight.png"
                   alt="">
              <img v-else
              ...
              <div v-if="doShowDataFour"
                   class="inseide">
                <div class="insideHover"
                     @click="finalStatus('15')">转入状态【手术开始】</div>
              </div>
            </div>
            <div>
              <dateTime width="110"
                        v-model="endDateTime"
                        @change="changeStatus('25','endDateTime',$event)"></dateTime>
          ...
          <div style="margin:0px 10px;"
            ...
            <div class="lightBox"
              ...
              <img v-if="lockedPatientInfo.operStatus == 25"
                   style="display:block"
                   src="../../assets/grayLight.png"
                   alt="">
              <img v-else-if="lockedPatientInfo.operStatus == 30"
                   style="display:block"
                   src="../../assets/redLight.png"
                   alt="">
              <img v-else
              ...
              <div v-if="doShowDataFive"
                   class="inseide">
                <div class="insideHover"
                     @click="finalStatus('25')">转入状态【手术结束】</div>
              </div>
            </div>
            <div>
              <dateTime width="110"
                        v-model="anesEndTime"
                        @change="changeStatus('30','anesEndTime',$event)"></dateTime>
          ...
          <div style="margin:0px 10px;"
            ...
            <div ref="area"
                 ...
                 class="lightBox">
              <img v-if="lockedPatientInfo.operStatus == 30"
                   style="display:block"
                   src="../../assets/grayLight.png"
                   alt="">
              <img v-else-if="lockedPatientInfo.operStatus == 35"
                   style="display:block"
                   src="../../assets/redLight.png"
                   alt="">
              <img v-else
              ...
              <div v-if="doShowDataSix"
                   class="inseide">
                <div class="insideHover"
                     @click="finalStatus('30')">转入状态【麻醉结束】</div>
                <div class="insideHover"
                     @click="finalStatus('60')">转入病房</div>
                <div class="insideHover"
                     @click="finalStatus('45')">进复苏室</div>
                <div class="insideHover"
                     @click="finalStatus('65')">转入ICU</div>
              </div>
            </div>
            <div>
              <dateTime width="110"
                        v-model="outDateTime"
                        @change="changeStatus('35','outDateTime',$event)"></dateTime>
        ...
        <div style="overflow:hidden;position:relative;height:30px;">
          <div v-if="lockedPatientInfo.patientId"
               ref="scollDiv"
      ...
      <div class="left"
        ...
        <div v-if="lockedPatientInfo.patientId"
          ...
          <div class="stretch">
            <div style="display:flex;">
              <img style="height:21px;padding-right:3px;"
                   src="../../assets/icon_1.png"
                   alt=""> 电子病历
            </div>
            <div class="active_back"
                 @click="concealmentOne"><img :class="{transform:isTransformOne}"
                   src="../../assets/bottom.png"></div>
          </div>
          <div v-if="concealmentOneData"
            ...
            <button v-if="lockedPatientInfo.patientId"
                    @click="openLisCheck"
                    class="list_button">检验信息</button>
            <button v-if="lockedPatientInfo.patientId"
                    @click="openMedical"
                    class="list_button">检查结果</button>
            <!-- <button v-if="lockedPatientInfo.patientId" class="list_button">医嘱信息</button> -->
            <button v-if="lockedPatientInfo.patientId"
                    @click="openRecodEmr"
                    class="list_button">病例病程</button>
          </div>
        </div>
        <div style="height: auto;background-color: #b3f2b1;margin-bottom:5px;"
          ...
          <div class="stretch">
            ...
            <div class="active_back"
                 @click="concealmentTwe"><img :class="{transform:isTransformTwe}"
                   src="../../assets/bottom.png"></div>
          </div>
          <div v-if="concealmentTweData"
               style="padding:5px;display:flex;flex-wrap:wrap;">
            <button class="list_button"
                    @click="openChangeRoom">更换房间</button>
            <button v-if="regButtonView"
                    class="list_button"
                    @click="getOperationRegister">术中登记</button>
            <button v-if="recoverButtonView"
                    class="list_button"
                    @click="getRecoverRegister">复苏登记</button>
            <button @click="cancel"
                    class="list_button">取消手术</button>
            <button v-if="formDetail"
                    class="list_button"
                    @click="monitor">监护仪</button>
        ...
        <div style="height: auto;background-color: #b3f2b1;margin-bottom:5px;">
          <div class="stretch">
            ...
            <div class="active_back"
                 @click="concealmentThree"><img :class="{transform:isTransformThree}"
                   src="../../assets/bottom.png"></div>
          </div>
          <div v-if="concealmentThreeData"
               style="padding:5px;display:flex;flex-wrap:wrap;">
            <button @click="dictShow"
                    class="list_button">字典</button>
            <button @click="tempManage"
                    class="list_button">模板管理</button>
          </div>
        </div>
        <div style="height: auto;background-color: #b3f2b1;margin-bottom:5px;">
          <div class="stretch">
            ...
            <div class="active_back"
                 @click="concealmentFour"><img :class="{transform:isTransformFour}"
                   src="../../assets/bottom.png"></div>
          </div>
          <div v-if="concealmentFourData"
               style="padding:5px;display:flex;flex-wrap:wrap;">
            <!-- <button class="list_button">系统配置</button> -->
            <!-- <button @click="getAboutUs" class="list_button">关于</button> -->
            <button @click="exitSystem"
                    class="list_button">返回列表</button>
            <button @click="openChangePassWordView"
                    class="list_button">修改密码</button>
          </div>
        </div>
          ...
          <div style="height:105px;border-bottom:1px solid #96e894;box-sizing:border-box;">
            <div>
              <div class="container"
                ...
                <img style="margin-right:10px;height:20px;"
                     src="../../assets/people.png"
                     alt="">
                ...
                <div style="margin-left:15px;">
                  ...
                  <select style="width: 60px;"
                    ...
                    <option value=""></option>
                    <option v-for="(item,index) in roomList"
                            :value="item.roomNo">{{ item.roomNo}}</option>
                  </select>
                </div>
              </div>
              <div class="container"
                ...
                <div class="left15"
                  ...
                  <span>ID</span>
                  <input @keyup.enter='searchPatientList'
            ...
            <div style="padding-left: 5px;">
              <button style="font-size:12px;"
                      @click='openJzView'>急诊登记</button>
              <button style="font-size:12px;"
                      @click='searchPatientList'>搜索</button>
            </div>
          </div>
          <div style="overflow-y: auto;height:calc(100% - 105px - 80px);font-size:12px;">
            <div v-for="item in patientList"
              ...
              <div class="patientContent title_back"
                ...
                <span v-if="item.emergencyIndicator == 1"
                      style="color:red;font-weight:bold;">急诊</span>
                <span v-if="item.operStatus == 0"
                      style="color:#15428B;font-weight:bold;">准备手术</span>
                <span v-if="item.operStatus == 5"
                      style="color:red;font-weight:bold;">入手术室</span>
                <span v-else-if="item.operStatus == 10"
                      style="color:red;font-weight:bold;">麻醉开始</span>
                <span v-else-if="item.operStatus == 15"
                      style="color:red;font-weight:bold;">手术开始</span>
                <span v-else-if="item.operStatus == 25"
                      style="color:red;font-weight:bold;">手术结束</span>
                <span v-else-if="item.operStatus == 30"
                      style="color:red;font-weight:bold;">麻醉结束</span>
                <span v-else-if="item.operStatus == 35"
                      style="color:green;font-weight:bold;">出手术室</span>
                <span v-else-if="item.operStatus == 60"
                      style="color:green;font-weight:bold;">转入病房</span>
                <span v-else-if="item.operStatus == 45"
                      style="color:green;font-weight:bold;">进复苏室</span>
                <span v-else-if="item.operStatus == 40"
                      style="color:green;font-weight:bold;">待复苏</span>
                <span v-else-if="item.operStatus == 65"
                      style="color:green;font-weight:bold;">转入ICU</span>
              </div>
            ...
            <div>
              ...
              <div style="display:flex;items-align:center;padding-top:10px;">
                <button @click="firstPage"
                        style="width:60px;font-size:12px;">首页</button>
                <button @click="pageRe"
                        style="width:60px;font-size:12px;">上一页</button>
                <div @click="showSelect"
                     class="pageInDiv">
                  <span>{{pageNum}}</span>
                  <div @click.stop="noClick"
                       v-if="dataInSelect"
                       class="pageInSelect">
                    <div @click="pageChoose(item.number)"
                         v-for="item in dataTypeInAllSelect">{{item.number}}</div>
                  </div>
                </div>
                <button @click="pageAd"
                        style="width:60px;font-size:12px;">下一页</button>
                <button @click="lastPage"
                        style="width:60px;font-size:12px;">末页</button>
              </div>
            </div>
            <div>
              <span>排序方式</span>
        ...
        <div class="patientInfo"
          ...
          <div style="margin-top: 5px;">
            <div class="title_back"
                 style="border:1px solid #b1f3c5;padding-left: 20px;">基本信息</div>
            <div class="patientContentBox">
              ...
              <div class="container">
                <div>住址</div>
                <div class="in_con"
                     style="width: 400px;">{{patientInfo.MAILING_ADDRESS}}</div>
          ...
          <div>
            <div class="title_back"
                 style="border:1px solid #b1f3c5;padding-left: 20px;">手术信息</div>
            <div class="patientContentBox">
              <div class="container">
                <div>主要诊断</div>
                <div class="in_con"
                     style="width: 600px;">{{patientInfo.DIAG_BEFORE_OPERATION}}</div>
              </div>
              <div class="container">
                <div>病情</div>
                <div class="in_con"
                     style="width: 600px;">{{patientInfo.PATIENT_CONDITION}}</div>
              </div>
              <div class="container">
                <div>手术名称</div>
                <div class="in_con"
                     style="width: 450px;max-height:42px;">{{patientInfo.OPERATION_NAME}}</div>
              ...
              <div class="container">
                <div>手术时间</div>
                <div class="in_con"
                     style="width: 160px;">{{patientInfo.SCHEDULED_DATE_TIME}}</div>
                ...
                <div class="in_con"
                     style="width:60px;">{{patientInfo.ISOLATION_INDICATOR}}</div>
              ...
              <div class="container">
                ...
                <div class="in_con"
                     style="width: 90px;">{{patientInfo.QIEKOU_CLASS}}</div>
          ...
          <div>
            <div class="title_back"
                 style="border:1px solid #b1f3c5;padding-left: 20px;">手术人员</div>
            <div class="patientContentBox">
              <div class="container">
                <div>麻醉医师</div>
          ...
          <div>
            <div class="title_back"
                 style="border:1px solid #b1f3c5;padding-left: 20px;">病人信息修改</div>
            <div class="patientContentBox">
              <div class="container">
              ...
              <div>
                ...
                <button @click="escBirth">取消</button>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="information"
          ...
          <div ref="mybox1">
            <div class="designArea"
              ...
              <div v-if="item.type == 'div'&&(item.width/2) <= 450"
                   class="item"
                   style="position:absolute;min-height: 3px;min-width:3px;"
                   :class="{choosed:item.chosen}"
                   v-for="item in formItems"
                   :style="{left:('450' - (item.width/2))+'px'}">
                <form-element ref="formElement"
                              :value="item"
                              :isPage="atherInput"
                              v-on:toTopEvent="getValue"
                              :objectItem="lockedPatientInfo"></form-element>
              </div>
              <div v-if="item.type == 'div'&&(item.width/2) >= 451"
                   class="item"
          ...
          <div ref="mybox"
            ...
            <div class="designArea"
              ...
              <div v-if="item.type == 'div'&&(item.width/2) <= 450"
                ...
                <form-element-print :value="item"
                                    :isPrint="isPrint"
                                    :isPage="atherInput"
                                    v-on:toTopEvent="getValue"
                                    :objectItem="lockedPatientInfo"></form-element-print>
              </div>
              <div v-if="item.type == 'div'&&(item.width/2) >= 451"
                   class="item"
                   style="position:absolute;min-height: 3px;min-width:3px;left:0;"
          ...
          <div v-if="formDetail"
            ...
            <button ref="buttonTest"
                    v-if="pageButtonView"
                    @click="toChangePage(0)">首页</button>
            <button v-if="pageButtonView"
                    @click="toChangePage(-1)">上一页</button>
            <button v-if="pageButtonView"
                    @click="toChangePage(1)">下一页</button>
            <button v-if="pageButtonView"
                    @click="toChangePage(2)">末页</button>
            <button v-if="tempButtonView"
                    @click="applyTemplateFun">应用模板</button>
            <button v-if="tempButtonView"
                    @click="openSaveTemView">保存模板</button>
            <button @click="submitSaveForm">保存</button>
            <button v-if="personView"
                    @click="openPatSetting">体征设置</button>
    ...
    <monitor v-if="monitorDataShow.noneData"
             :dataOfNoneClick="firstRoom"
             :parentToChild="monitorDataShow"></monitor>
    <patientOperationInfo v-if="patientOperationInfoView.dataInParent"
                          :info="patientInfo"
                          :parentToChild="patientOperationInfoView"
                          v-on:submitSave="submitPatientInfo"
                          v-on:turnToSetting="toSetting"></patientOperationInfo>
    <operationRegister @refreshTime="timeChangeBus()"
                       v-if="operationRegisterView.dataInParent"
                       :objectItem="lockedPatientInfo"
                       :parentToChild="operationRegisterView"></operationRegister>
    <!-- 模板管理 -->
    <div v-if="tempView"
         class="dictionaries">
      <updateTemplet style="position: absolute;top: 10%;"
                     :style="{left:inleft+'px'}"
                     v-on:closeWin="closeTempManage"></updateTemplet>
    </div>
    ...
    <aboutUs v-if="aboutUsData.dataInParent"
             :parentToChild="aboutUsData"></aboutUs>
    <!-- 检验信息 -->
    <checkInfo v-if="checkInfoView"
               v-on:closeView="closeCheckInfoView"></checkInfo>
    <!-- 检验结果 -->
    <checkResult v-if="checkResultShow"
                 v-on:closeView="closeCheckInfoShow"></checkResult>
    <!-- 密码修改 -->
    <div class="dictionaries"
         v-if="changePassWord">
      ...
      <div class="window_load">
        ...
        <div v-if="commoTerms"
          ...
          <div style="display: flex;height: 100%;background:white;margin:10px;">
            ...
            <div style="width: 70%;margin-top:5px;">
              <div style="display: flex;margin-left: 10px;box-sizing:border-box;padding-right:18px;">
                <div class="topList"
                     v-for="cell in contentConfig">{{cell.text}}</div>
              </div>
              <div style="overflow-y: auto;height:280px;box-sizing:border-box;"
                   :class="{paddingRight18:this.paddingRight18}">
                <div v-for="list in commonTypeList"
                     style="display: flex;margin-left: 10px;"
                     @click="getItem(list)">
                  <div v-for="cl in contentConfig"
                       style="width: 160px;border:1px solid #b1f3c5;">
                    <div style="height:calc(100% - 2px);"
                         v-if="cl.status=='inable'">
                      <input v-if="list.writeAble"
                             type="text"
          ...
          <div style="text-align: right;margin-right: 30px;">
            <button style="width: 80px;height: 25px;font-size:12px;"
                    @click="addMedAnesthesiaInputDict"
                    :disabled="isAdd">新增</button>
            <button style="width: 80px;height: 25px;font-size:12px;"
                    :disabled="isSave"
                    @click="saveValue">保存</button>
            <button style="width: 80px;height: 25px;font-size:12px;"
                    @click="cancleEdit"
                    :disabled="isCancle">取消</button>
            <button style="width: 80px;height: 25px;font-size:12px;"
                    :disabled="isDelete"
                    @click="deleteByMedAnesthesiaInputDict">删除</button>
          </div>
        </div>
        <anaesthesiaEvent v-if="anaesthesiaEvent"
                          :eventChildData="eventDataType"></anaesthesiaEvent>
    ...
    <div>
      <!-- 急诊登记 -->
      <jzRegisterContent v-if="jzPatientView"
                         v-on:closeJzViewChild="closeJzView"></jzRegisterContent>
    </div>
    <cancel v-if="cancelData.dataInParent"
            :dataInParent="cancelData"
            @cancelFun="cancelFun"></cancel>
  </div>
  <div v-else
       style="height: 100%;width: 100%;z-index: 99;position:relative;">
    <div class="load_top">
      <div>表单设计器</div>
      <div @click="formSetting"
           class="top_active">X</div>
    </div>
 ...
 CLODOP.On_Return = function (TaskID, Value) {
    ...
    getMaxTime () {
      ...
      if (
        ...
        this.lockedPatientInfo.operStatus == 10 ||
        this.lockedPatientInfo.operStatus == 15 ||
...
.tab_div:hover span {
  text-shadow: 18px 15px 20px #e3efff, -15px 15px 20px #e3efff;
}
...
.hoverStyle:hover {
  background-color: rgb(81, 187, 76);
  color: #fff;
}
...
.bindClass {
  background: linear-gradient(#e3f5e6, #b9eec0, #9feeae);
  color: #23933b;
  /* border-top-left-radius: 3px;
    border-top-right-radius: 3px; */
  border-right: 1px solid #79e47e;
  border-left: 1px solid black;
}

.bindClass:hover {
  background: linear-gradient(#e3f5e6, #cbf7ce, #dbf9dd);
}
